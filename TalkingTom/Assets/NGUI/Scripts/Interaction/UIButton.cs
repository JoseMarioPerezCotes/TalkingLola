...
public class UIButton : UIButtonColor
{
	...
	protected virtual void OnClick ()
	{
		if (current == null && isEnabled)
		{
			...
			//{
               // if (!this.gameObject.GetComponent<UIPlaySound>())
               // {
                   // this.gameObject.AddComponent<UIPlaySound>();
                    //this.gameObject.GetComponent<UIPlaySound>().audioClip = InitializePlugins._instance.buttonClick;
                    //					this.gameObject.GetComponent<UIPlaySound>().Play ();
              //  }
           // }
			current = this;
